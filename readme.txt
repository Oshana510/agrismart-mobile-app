...
----------------------------------
- GitHub Repository: https://github.com/Oshana510/agrismart-mobile-app
- Backend URL: https://agrismart-mobile-app-production.up.railway.app/
...
- Media & File System: expo-image-picker for profile photo uploads.
...
- Security & Authentication: JSON Web Tokens (JWT), bcryptjs for robust password hashing.
...
6. Labor Management (Module IT24100786)
- Workforce Registry: Record laborer details, daily wage rates, and specific roles.
...
2. npm install
3. npm start
4. Scan the generated QR code using the Expo Go application.
...
4. npm run dev
5. *If testing locally:* Update the API_URL in frontend/src/services/api.js to point to your local machine's network IP (e.g., http://192.168.1.X:5000/api) instead of the Railway production URL.
